...
@section('title', 'إضافة سلاح')
@section('page-title', 'إضافة سلاح أو مضبوط ناري')
@section('page-subtitle', 'تسجيل بيانات السلاح والبيانات القانونية')
...
<form method="POST" action="{{ route('weapons.store') }}" id="weapon-form">
    @csrf
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 p-3 position-sticky top-0 bg-white"
        ...
        <h1 class="mb-0 fw-bold" style="font-size:1.1rem;">إضافة سلاح جديد</h1>
        <div class="d-flex gap-2">
            <a href="{{ route('weapons.index') }}" class="btn btn-brutal-ghost px-4">← إلغاء</a>
            <button type="submit" id="submit-btn" class="btn btn-brutal-primary px-5">حفظ البيانات</button>
        </div>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="weapon_condition" name="weapon_condition" rows="2"
                                  placeholder="صالح للاستخدام، تالف، معدل، مكسور الغلاف..."
                                  class="form-control @error('weapon_condition') is-invalid @enderror">{{ old('weapon_condition') }}</textarea>
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input id="related_report_number" type="text" name="related_report_number"
                               value="{{ old('related_report_number') }}"
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="holder_info" name="holder_info" rows="3"
                                  placeholder="الاسم الرباعي — الرقم القومي — العنوان — رقم الرخصة (إن وجد)..."
                                  class="form-control @error('holder_info') is-invalid @enderror">{{ old('holder_info') }}</textarea>
                        <div class="mt-1" style="font-size:.7rem;color:rgba(26,26,26,.45);">أدخل جميع بيانات الحائز في خانة واحدة (نص حر)</div>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <textarea id="notes" name="notes" rows="4"
                                  placeholder="مثال: ضُبط معه 15 طلقة 9mm — السلاح في حوزة المتهم وقت الضبط..."
